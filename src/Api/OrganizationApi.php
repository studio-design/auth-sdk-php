...
class OrganizationApi
{
     ...
     *
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMyOrganization'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Studio\Auth\Model\MyOrganization
     */
    public function getMyOrganization(
        string $organizationId,
        string $contentType = self::contentTypes['getMyOrganization'][0]
    ): \Studio\Auth\Model\MyOrganization
    {
        [$response] = $this->getMyOrganizationWithHttpInfo($organizationId, $contentType);

        return $response;
    }

    /**
     * Operation getMyOrganizationWithHttpInfo
     *
     * 自分が所属する組織情報取得（組織メンバー向け）
     *
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Studio\Auth\Model\MyOrganization, 1: int, 2: array<string, string[]>}
     */
    public function getMyOrganizationWithHttpInfo(
        string $organizationId,
        string $contentType = self::contentTypes['getMyOrganization'][0]
    ): array
    {
        $request = $this->getMyOrganizationRequest($organizationId, $contentType);
    ...
    /**
     * Operation getMyOrganizationAsync
     *
     * 自分が所属する組織情報取得（組織メンバー向け）
     *
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     ...
     * @return PromiseInterface
     */
    public function getMyOrganizationAsync(
        string $organizationId,
        string $contentType = self::contentTypes['getMyOrganization'][0]
    ): PromiseInterface
    {
        return $this->getMyOrganizationAsyncWithHttpInfo($organizationId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMyOrganizationAsyncWithHttpInfo
     *
     * 自分が所属する組織情報取得（組織メンバー向け）
     *
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     ...
     * @return PromiseInterface
     */
    public function getMyOrganizationAsyncWithHttpInfo(
        string $organizationId,
        string $contentType = self::contentTypes['getMyOrganization'][0]
    ): PromiseInterface
    {
        $returnType = '\Studio\Auth\Model\MyOrganization';
        $request = $this->getMyOrganizationRequest($organizationId, $contentType);
    ...
    /**
     * Create request for operation 'getMyOrganization'
     *
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMyOrganization'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMyOrganizationRequest(
        string $organizationId,
        string $contentType = self::contentTypes['getMyOrganization'][0]
    ): Request
    {
        ...
        if ($organizationId === null || (is_array($organizationId) && count($organizationId) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $organizationId when calling getMyOrganization'
            );
        }
     ...
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     * @param  string $memberId メンバー識別子（UUID形式）。 (required)
     * @param  \Studio\Auth\Model\OrganizationMemberUpdateRequest $organizationMemberUpdateRequest organizationMemberUpdateRequest (required)
    ...
    public function updateMemberRole(
        string $organizationId,
        string $memberId,
        \Studio\Auth\Model\OrganizationMemberUpdateRequest $organizationMemberUpdateRequest,
        string $contentType = self::contentTypes['updateMemberRole'][0]
    ): \Studio\Auth\Model\OrganizationMember
    {
        [$response] = $this->updateMemberRoleWithHttpInfo($organizationId, $memberId, $organizationMemberUpdateRequest, $contentType);
     ...
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     * @param  string $memberId メンバー識別子（UUID形式）。 (required)
     * @param  \Studio\Auth\Model\OrganizationMemberUpdateRequest $organizationMemberUpdateRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateMemberRole'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \Studio\Auth\Model\OrganizationMember, 1: int, 2: array<string, string[]>}
     */
    public function updateMemberRoleWithHttpInfo(
        string $organizationId,
        string $memberId,
        \Studio\Auth\Model\OrganizationMemberUpdateRequest $organizationMemberUpdateRequest,
        string $contentType = self::contentTypes['updateMemberRole'][0]
    ...
    {
        $request = $this->updateMemberRoleRequest($organizationId, $memberId, $organizationMemberUpdateRequest, $contentType);
    ...
    {
        return $this->updateMemberRoleAsyncWithHttpInfo($organizationId, $memberId, $organizationMemberUpdateRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function updateMemberRoleAsyncWithHttpInfo(
        string $organizationId,
        string $memberId,
        \Studio\Auth\Model\OrganizationMemberUpdateRequest $organizationMemberUpdateRequest,
        string $contentType = self::contentTypes['updateMemberRole'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateMemberRoleRequest(
        string $organizationId,
        string $memberId,
        \Studio\Auth\Model\OrganizationMemberUpdateRequest $organizationMemberUpdateRequest,
        string $contentType = self::contentTypes['updateMemberRole'][0]
    ): Request
    {
        ...
        if ($organizationId === null || (is_array($organizationId) && count($organizationId) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $organizationId when calling updateMemberRole'
            );
        }
        ...
        if ($memberId === null || (is_array($memberId) && count($memberId) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $memberId when calling updateMemberRole'
            );
        }

        // verify the required parameter 'organizationMemberUpdateRequest' is set
        if ($organizationMemberUpdateRequest === null || (is_array($organizationMemberUpdateRequest) && count($organizationMemberUpdateRequest) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $organizationMemberUpdateRequest when calling updateMemberRole'
            );
        }
        ...
        // for model (json/xml)
        if (isset($organizationMemberUpdateRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($organizationMemberUpdateRequest));
            } else {
                $httpBody = $organizationMemberUpdateRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation updateMyOrganization
     *
     * 自分が所属する組織情報更新（組織メンバー向け）
     *
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     * @param  \Studio\Auth\Model\OrganizationUpdateRequest $organizationUpdateRequest organizationUpdateRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateMyOrganization'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Studio\Auth\Model\Organization
     */
    public function updateMyOrganization(
        string $organizationId,
        \Studio\Auth\Model\OrganizationUpdateRequest $organizationUpdateRequest,
        string $contentType = self::contentTypes['updateMyOrganization'][0]
    ): \Studio\Auth\Model\Organization
    {
        [$response] = $this->updateMyOrganizationWithHttpInfo($organizationId, $organizationUpdateRequest, $contentType);

        return $response;
    }

    /**
     * Operation updateMyOrganizationWithHttpInfo
     *
     * 自分が所属する組織情報更新（組織メンバー向け）
     *
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     * @param  \Studio\Auth\Model\OrganizationUpdateRequest $organizationUpdateRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateMyOrganization'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     ...
     */
    public function updateMyOrganizationWithHttpInfo(
        string $organizationId,
        \Studio\Auth\Model\OrganizationUpdateRequest $organizationUpdateRequest,
        string $contentType = self::contentTypes['updateMyOrganization'][0]
    ): array
    {
        $request = $this->updateMyOrganizationRequest($organizationId, $organizationUpdateRequest, $contentType);
    ...
    /**
     * Operation updateMyOrganizationAsync
     *
     * 自分が所属する組織情報更新（組織メンバー向け）
     *
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     ...
     * @return PromiseInterface
     */
    public function updateMyOrganizationAsync(
        string $organizationId,
        \Studio\Auth\Model\OrganizationUpdateRequest $organizationUpdateRequest,
        string $contentType = self::contentTypes['updateMyOrganization'][0]
    ): PromiseInterface
    {
        return $this->updateMyOrganizationAsyncWithHttpInfo($organizationId, $organizationUpdateRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateMyOrganizationAsyncWithHttpInfo
     *
     * 自分が所属する組織情報更新（組織メンバー向け）
     *
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     ...
     * @return PromiseInterface
     */
    public function updateMyOrganizationAsyncWithHttpInfo(
        string $organizationId,
        \Studio\Auth\Model\OrganizationUpdateRequest $organizationUpdateRequest,
        string $contentType = self::contentTypes['updateMyOrganization'][0]
    ): PromiseInterface
    ...
    /**
     * Create request for operation 'updateMyOrganization'
     *
     * @param  string $organizationId 組織識別子（UUID形式）。 (required)
     * @param  \Studio\Auth\Model\OrganizationUpdateRequest $organizationUpdateRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateMyOrganization'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateMyOrganizationRequest(
        string $organizationId,
        \Studio\Auth\Model\OrganizationUpdateRequest $organizationUpdateRequest,
        string $contentType = self::contentTypes['updateMyOrganization'][0]
    ): Request
    {
        ...
        if ($organizationId === null || (is_array($organizationId) && count($organizationId) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $organizationId when calling updateMyOrganization'
            );
        }
        ...
        if ($organizationUpdateRequest === null || (is_array($organizationUpdateRequest) && count($organizationUpdateRequest) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $organizationUpdateRequest when calling updateMyOrganization'
            );
        }
