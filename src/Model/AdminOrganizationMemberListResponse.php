 ...
 */
class AdminOrganizationMemberListResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdminOrganizationMemberListResponse';
    ...
    */
     ...
     * Sets data
     *
     * @param \Studio\Auth\Model\OrganizationMember[] $data 組織メンバーの配列。
     *
     * @return $this
     */
