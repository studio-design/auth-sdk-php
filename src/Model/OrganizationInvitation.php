 ...
 *
 * @description 組織への招待情報。 メンバーを組織に招待する際に作成されます。
 * @package  Studio\Auth
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class OrganizationInvitation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id 招待識別子（UUID形式、一意）。
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status 招待のステータス。 - `pending`: 招待が送信され、承認待ち。 - `accepted`: 招待が承認された。 - `expired`: 招待の有効期限が切れた。 - `revoked`: 招待が取り消された。
     *
     * @return $this
     */
     ...
     * Sets createdAt
     *
     * @param \DateTime $createdAt 招待作成日時（ISO 8601 形式）。
     *
     * @return $this
     */
