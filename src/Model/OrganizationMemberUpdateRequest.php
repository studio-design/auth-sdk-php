...
/**
 * OrganizationMemberUpdateRequest Class Doc Comment
 *
 * @description メンバーロール変更リクエスト（組織メンバー向け）。
 * @package  Studio\Auth
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class OrganizationMemberUpdateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrganizationMemberUpdateRequest';
