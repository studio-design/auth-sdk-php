...
/**
 * ServiceInfoResponse Class Doc Comment
 *
 * @description サービス情報のレスポンススキーマ。サービス名と OpenID Connect Discovery エンドポイントへのリンクを含みます。
 * @package  Studio\Auth
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class ServiceInfoResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ServiceInfoResponse';
    ...
    */
     ...
     * Sets documentation
     *
     * @param string $documentation OpenID Connect Discovery エンドポイントの URL
     *
     * @return $this
     */
