...
/**
 * AdminOrganizationMemberUpdateRequest Class Doc Comment
 *
 * @description メンバーロール変更リクエスト。
 * @package  Studio\Auth
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class AdminOrganizationMemberUpdateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdminOrganizationMemberUpdateRequest';
