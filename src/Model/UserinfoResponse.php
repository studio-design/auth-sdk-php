 ...
 *
 * @description UserInfo エンドポイントのレスポンス。 アクセストークンに関連付けられたユーザーの情報を返します (OpenID Connect Core 1.0 Section 5.3)。  返却されるクレームは、認可リクエスト時に要求されたスコープに依存します: - &#x60;openid&#x60;: sub (必須) - &#x60;profile&#x60;: name - &#x60;email&#x60;: email, email_verified
 * @package  Studio\Auth
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class UserinfoResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UserinfoResponse';
    ...
    */
     ...
     * Sets sub
     *
     * @param string $sub サブジェクト識別子 (Subject Identifier)。 発行者内でユーザーを一意に識別する値。
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name ユーザーのフルネーム。 `profile` スコープが要求された場合に含まれます。
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string|null $email ユーザーのメールアドレス。 `email` スコープが要求された場合に含まれます。
     *
     * @return $this
     */
     ...
     * Sets emailVerified
     *
     * @param bool|null $emailVerified メールアドレスが検証済みかどうか。 `email` スコープが要求された場合に含まれます。
     *
     * @return $this
     */
