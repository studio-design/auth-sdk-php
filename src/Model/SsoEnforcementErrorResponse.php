...
/**
 * SsoEnforcementErrorResponse Class Doc Comment
 *
 * @description SSO 強制判定エンドポイントのエラーレスポンス
 * @package  Studio\Auth
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class SsoEnforcementErrorResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SsoEnforcementErrorResponse';
