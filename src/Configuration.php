...
class Configuration
{
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/0.2.27-rc.8/PHP';
    ...
    {
        $report  = 'PHP SDK (Studio\Auth) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 0.2.26' . PHP_EOL;
        $report .= '    SDK Package Version: 0.2.27-rc.8' . PHP_EOL;
