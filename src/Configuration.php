...
class Configuration
{
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/0.2.26-rc.6/PHP';
    ...
    public static function toDebugReport(): string
    {
        ...
        $report .= '    The version of the OpenAPI document: 0.2.25' . PHP_EOL;
        $report .= '    SDK Package Version: 0.2.26-rc.6' . PHP_EOL;
